...
//    public static final String SERVER_URL = "http://s1.wisports.cn:8095";
    ...
    public static final String SERVER_PAGE = UNZIP_PATH + "/Index.html";
    ...
    public static final String TEMPLATE_PATH = UNZIP_PATH + "/templates";
    ...
    public static final int REQUEST_CODE_TAKE_PICTURE = 0x00000001;

    public static final int REQUEST_CODE_TAKE_CAPTURE = 0x00000002;

    public static final int REQUEST_CODE_REUSLT_PICTURE = 0x00000003;
    ...
    public static final long GET_SERVER_PUSH_DELAY = 1000 * 30;
